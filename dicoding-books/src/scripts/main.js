function main() {
    ...
    const getBook = () => {
        ...
        fetch(`${baseUrl}/list`)
         ...
         //Menggunakan Async/await (Ubah menjadi const getBook = async () => {)
        //  try {
    ...
    const insertBook = (book) => {
        ...
        //Menggunakan async/await (Ganti dengan const insertBook = async (book) => {)
        // try{
        //     const options = {
        //         method: "POST",
        //         headers: {
    ...
    const updateBook = (book) => {
        ...
        fetch(`${baseUrl}/edit/${book.id}`, {
         ...
         //Menggunakan Async/await (Ganti  const updateBook = async (book) => {)
       //   try {
       //      const options = {
       //          method: "PUT",
       //          headers: {
